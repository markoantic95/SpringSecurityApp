...
import com.marko.securityApp.payload.ApiResponse;
import com.marko.securityApp.payload.JwtAuthenticationResponse;
import com.marko.securityApp.payload.LoginRequest;
import com.marko.securityApp.payload.SignUpRequest;
import com.marko.securityApp.repository.RoleRepository;
import com.marko.securityApp.repository.UserRepository;
import com.marko.securityApp.security.JwtTokenProvider;
...
public class AuthController {
    ...
    // @Valid - checks if login requests attributes are valid. for example usernameOrEmail has @NotBlank annotation.
    @PostMapping("/signin")
