...
//Spring Security will use the information stored in the UserPrincipal object to perform authentication and authorizatio
public class UserPrincipal implements UserDetails{
    ...
    //we can think of each GrantedAuthority as an individual privilege. Examples could include READ_AUTHORITY, WRITE_PRIVILEGE, or even CAN_EXECUTE_AS_ROOT
